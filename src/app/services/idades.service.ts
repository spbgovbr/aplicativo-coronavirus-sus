...
export class IdadesService {
  ...
  getCDN(objectId): Promise<any> {
    return new Promise<any>((resolve) => {
      ...
      this.http.get(encodeURI(URL_CDN + '/idades?where=' + params),
        ...
        this.http.get('assets/data/idades-' + this.storage.get('LANGUAGE') + '.json').toPromise().then((response: any) => {
